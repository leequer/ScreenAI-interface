<!--
* @file LoveApartment.vue
* @description 爱情公寓一言生成器
* @author UIED技术团队
* @copyright UIED技术团队 (https://fsuied.com)
* @createDate 2025-1-9
*
* API文档:
* 1. 接口地址: https://api.tangdouz.com/aqgy.php
* 2. 请求方式: GET
* 3. 请求参数: 无
* 4. 响应格式: text/plain
* 5. 示例响应: "曾小贤:我不是人生赢家，我只是一个普通人，一个想要为了自己所爱的人变得更好的普通人。"
* 6. 错误处理: 当API请求失败时会自动使用本地数据
*
* 功能特性：
* 1. 自动获取爱情公寓经典台词
* 2. 一键复制功能
          ...
          <h2 class="text-4xl font-bold mb-3 relative inline-flex flex-col items-center">
            <div class="relative px-12">
              <span class="text-gray-800 hover:text-gray-600 transition-colors duration-300 cursor-pointer"
                @click="getRandomQuote">爱情公寓一言</span>
            </div>
          </h2>
          <p class="text-gray-500 text-sm mt-6">每次都能获取一条爱情公寓经典台词</p>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="border border-gray-100 rounded-lg p-6">
              <div class="flex items-center space-x-3 mb-4">
                ...
                <h4 class="text-base font-medium text-gray-900">经典台词</h4>
              </div>
        ...
        <div class="mt-12">
          ...
          <div class="space-y-6">
            <div class="pb-6 border-b border-gray-200 last:border-0">
              <h4 class="text-base font-medium text-gray-900 mb-3">台词内容从哪里来？</h4>
              <p class="text-sm text-gray-600 leading-relaxed">
                所有台词均来自《爱情公寓》系列电视剧，经过精心筛选和整理。
              </p>
            </div>
            <div class="pb-6 border-b border-gray-200 last:border-0">
              <h4 class="text-base font-medium text-gray-900 mb-3">更新频率如何？</h4>
              <p class="text-sm text-gray-600 leading-relaxed">
                支持实时更新，您可以随时点击"换一条"按钮获取新的台词内容。
              </p>
            </div>
            <div class="pb-6 border-b border-gray-200 last:border-0">
              <h4 class="text-base font-medium text-gray-900 mb-3">可以收藏喜欢的台词吗？</h4>
              <p class="text-sm text-gray-600 leading-relaxed">
                目前支持复制功能，您可以将喜欢的台词复制保存。
              </p>
            </div>
...
// 本地备用数据
const localQuotes = [
  "我不是人生赢家，我只是一个普通人，一个想要为了自己所爱的人变得更好的普通人。",
  "生活不是电影，没有那么多的不期而遇，只有久别重逢。",
  "我们都在努力奔跑，我们都是追梦人。",
  "我们都在寻找属于自己的位置，这个过程很累，但是很值得。",
  "有些人说不出再见，就真的再也不见。",
  "我们都在时光里跌跌撞撞的成长，也许有一天，我们会遇见最好的自己。",
  "我们都是孤独的人，但我们都不是一个人。",
  "有些事，不是你努力就可以得到，但是你不努力，就一定得不到。",
  "我们都在寻找自己的方向，也许有一天，我们会找到属于自己的那片天空。",
...
/**
 * 获取随机爱情公寓台词
 * API: https://api.tangdouz.com/aqgy.php
 */
const getRandomQuote = async () => {
  try {
    ...
    const apiUrl = isDev
      ? '/api/aqgy'  // 开发环境使用代理
      : 'https://api.tangdouz.com/aqgy.php'  // 生产环境直接调用
...
const copyText = async () => {
  try {
    const textToCopy = `${currentQuote.value}\n——来自《爱情公寓》`
