    ...
    <div>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.wh" placeholder="" class="input-with-select">
            <template #append>
        ...
        <div class="custom-box-single">
          ...
          <el-input v-model="info.mmwh" placeholder="" class="input-with-select">
            <template #append>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.kwh" placeholder="" class="input-with-select">
            <template #append>
        ...
        <div class="custom-box-single">
          ...
          <el-input v-model="info.mwh" placeholder="" class="input-with-select">
            <template #append>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.j" placeholder="" class="input-with-select">
            <template #append>
        ...
        <div class="custom-box-single">
          ...
          <el-input v-model="info.kj" placeholder="" class="input-with-select">
            <template #append>
