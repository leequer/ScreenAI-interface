    ...
    <div>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.w" placeholder="" class="input-with-select">
            <template #append>
        ...
        <div class="custom-box-single">
          ...
          <el-input v-model="info.mmw" placeholder="" class="input-with-select">
            <template #append>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.kw" placeholder="" class="input-with-select">
            <template #append>
        ...
        <div class="custom-box-single">
          ...
          <el-input v-model="info.mw" placeholder="" class="input-with-select">
            <template #append>
      ...
      <div class="custom-box">
        <div class="custom-box-single">
          ...
          <el-input v-model="info.gw" placeholder="" class="input-with-select">
            <template #append>
